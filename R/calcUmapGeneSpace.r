...
# this snippet uses retuculate python interface to run umap python tool. Standard Seurat does not allow
# changing some parameter value, particularly Spread
# also it allows to perform transformation on the subset of cells ("WT") 
...
#  we cannot subset to WT because WT depends on imputation on the WT cells
