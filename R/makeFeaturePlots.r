...
# this snippen makes feature plots for all genes, eigher in the taqman list or in the nanostring list. The list controls positions of subplots.
# cells with expression of target gene below minCutoff are colored in blue
# the bottom right corner contains the umap images with cells colored according to seuratObj coloring set by setClusterColors.r
#
...
if( seuratObj@project.name == "taqman"){ 
	...
	featurePlotList <- FeaturePlot( seuratObj, c( 	"sox9b"		, "snai1b"	, "sox10"	, "pax7b"	, "mbpa"	,
