...
# This snippet draws a heatmap of gene expression data (found in seuratObj@data) and annotates clusters
# according seuratObj@ident with colors taken from setClusterColors.r
# The order of clusters is set manually, so that eHMP and ltHMP are at the bottom of the legend and in the left of the graph
#
# written by Vsevolod Makeev 2017 - 2021 
