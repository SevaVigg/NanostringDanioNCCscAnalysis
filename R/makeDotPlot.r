...
# this snippet plots seurat DotPlots in high or low quality. 
# if balanced == FALSE it uses original seurat version with separate normalization of coloring for different genes
# otherwise it uses dotPlotBalanced with coloring normalized over all cells
#
# Written by Seva Makeev 4.05.2021
